...
export default function Privacy() {
  return (
    <section
      className="relative min-h-screen flex items-start justify-center overflow-hidden bg-white px-5 pt-[120px] pb-24"
    >
      <div className="absolute inset-0 overflow-clip pointer-events-none">
        <div
          className="absolute blur-[5px] opacity-20"
      ...
      <div className="relative z-10 max-w-[760px] w-full mx-auto">
        ...
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-3 bg-white border border-gray-200 rounded-[24px] px-4 py-2 shadow-sm"
        >
          <span className="w-2 h-2 rounded-full bg-[#37b24d]" />
          <span
        ...
        <motion.h1
          ...
          className="text-[#1a1a2e] mb-3 leading-none"
          style={{
        ...
        >
          Privacy{" "}
          <span style={{ color: "#37b24d" }}>Policy</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-[#6b7280] mb-12 max-w-[520px]"
          style={{
            fontFamily: "'Poppins',sans-serif",
            fontWeight: 400,
        ...
        <div className="flex flex-col gap-4">
          {sections.map((s, i) => (
            <motion.div
              ...
              whileHover={{ borderColor: "rgba(55,178,77,0.3)" }}
              className="bg-white border border-gray-200 rounded-[20px] p-6 flex gap-5 transition-colors duration-200 shadow-sm"
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-[12px] bg-gray-50 border border-gray-200 flex items-center justify-center mt-0.5">
                {s.icon}
              </div>
              ...
              <div>
                ...
                <p
                  className="text-[#6b7280] leading-[1.7]"
                  style={{
                    fontFamily: "'Poppins',sans-serif",
                    fontWeight: 400,
                    fontSize: "0.9rem",
        ...
        <motion.div
          ...
          className="bg-white border border-gray-200 rounded-[24px] p-8 shadow-sm"
        >
          <h2
          ...
          <div className="flex flex-col gap-3">
            {contactItems.map((item, i) => (
              ...
              >
                <div className="w-8 h-8 rounded-[10px] bg-gray-50 border border-gray-200 flex items-center justify-center text-[#37b24d] flex-shrink-0">
                  {item.icon}
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center gap-0 sm:gap-3">
                  ...
                  {item.href ? (
                    <a
                      ...
                      className="text-[#1a1a2e] hover:text-[#37b24d] transition-colors duration-150"
          ...
          <motion.a
            ...
            style={{
              ...
              fontSize: "0.95rem",
              background: "#37b24d",
              boxShadow: "0px 20px 17.5px rgba(55,178,77,0.2)",
            }}
          >
        ...
        <motion.p
          ...
          className="text-center text-[#d1d5db] mt-10"
